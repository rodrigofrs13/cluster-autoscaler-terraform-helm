...
#         Effect = "Allow",
#         Principal = {
#           Federated = "arn:aws:iam::246732148991:oidc-provider/oidc.eks.us-east-1.amazonaws.com/id/D67FEF7CB03B47B5F5932BE0E205A5F4"
#          },
#         Action = "sts:AssumeRoleWithWebIdentity",
#         Condition = {
#           StringEquals = {
#             "oidc.eks.${var.region}.amazonaws.com/id/D67FEF7CB03B47B5F5932BE0E205A5F4:aud" = "sts.amazonaws.com"
#             "oidc.eks.${var.region}.amazonaws.com/id/D67FEF7CB03B47B5F5932BE0E205A5F4:sub" = "system:serviceaccount:kube-system:cluster-autoscaler"
#           }
#         }
#       },
#     ],
